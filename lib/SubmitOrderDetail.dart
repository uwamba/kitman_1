...
class SubmitOrderDetail extends StatefulWidget {
  final ActiveOrderModel activeOrderModel;

  SubmitOrderDetail(this.activeOrderModel);

  @override
  _SubmitOrderDetail createState() {
    return _SubmitOrderDetail();
  }
}

class _SubmitOrderDetail extends State<SubmitOrderDetail> {
  ...
  Widget build(BuildContext context) {
    ...
    double bottomImageHeight = ConstantWidget.getPercentSize(bottomHeight, 30);
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            ConstantWidget.getTextWidget(
                                "We are looking for the best courier to pick-up and deliver as soon as possible.",
                                Colors.grey,
                                TextAlign.start,
                                FontWeight.w400,
                                ConstantData.font18Px),
