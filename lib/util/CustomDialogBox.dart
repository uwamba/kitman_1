      ...
      children: <Widget>[
        Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              ConstantWidget.getCustomText(widget.title, ConstantData.mainTextColor, 1, TextAlign.center,FontWeight.w600,20)
              ...
              ConstantWidget.getCustomText(widget.descriptions,ConstantData.mainTextColor,2,TextAlign.center,FontWeight.normal,14)
        ...
        ,
              ...
              Container(
                ...
                child: ConstantWidget.getRoundCornerButtonWithoutIcon(
                    widget.text, ConstantData.primaryColor, Colors.white, 20, () {
