...
import 'package:flutter_courier_delivery/place_picker_custom/place_picker.dart';
...
class CompleteOrderDetail extends StatefulWidget {
  ...
  CompleteOrderDetail(this.activeOrderModel);

  @override
  _CompleteOrderDetail createState() {
    return _CompleteOrderDetail();
  }
}

class _CompleteOrderDetail extends State<CompleteOrderDetail> {
