...
class MotionTabBar extends StatefulWidget {
  ...
  @override
  _MotionTabBarState createState() => _MotionTabBarState(this.selectedIndex);
}
...
class _MotionTabBarState extends State<MotionTabBar>
  ...
  _MotionTabBarState(this.selectedIndex);
    ...
    return Stack(
      ...
      children: <Widget>[
        Container(
          ...
          decoration: BoxDecoration(color: ConstantData.bgColor, boxShadow: [
            BoxShadow(
              color: ConstantData.shadowColor.withOpacity(0.5),
              offset: Offset(0, -1),
              blurRadius: 5,
            ),
          ]),
                      ...
                      child: Container(
                        ...
                        child: Padding(
                          child: Opacity(
                            ...
                            child: Image.asset(
                                ConstantData.assetsPath + activeIcon,
                                color: Colors.white),
                            // child: Icon(
                            //   activeIcon,
                            //   color: Colors.white,
                          ...
                          padding: EdgeInsets.all(
                              ConstantWidget.getPercentSize(60, 20)),
                        ),
                      ),
                    ),
                  ],
...
class HalfPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawPath(path, Paint()..color = ConstantData.bgColor);
  }
