...
class OrderDetailsDriver extends StatefulWidget {
  ...
  OrderDetailsDriver(this.activeOrderModel);
  @override
  _OrderDetailsDriver createState() {
    return _OrderDetailsDriver();
  }
}

class _OrderDetailsDriver extends State<OrderDetailsDriver> {
  ...
  Widget build(BuildContext context) {
    currentState = widget.activeOrderModel.status;
    Db db = new Db();
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            IconButton(
                                ...
                                onPressed: () {
                                  setState(() {
                                    print("ooooooooooooooooooooooook");
                                    newState = changeStatus(currentState);
                                    db.updateStatus(
                                        widget.activeOrderModel.orderNumber,
                                        newState);
                                  });
